...
export function createServiceabilityQuerySchema(defaultCourierPartner: string) {
  return z
    .object({
      courier_partner: z
        .string()
...
export const serviceabilityQuerySchema = createServiceabilityQuerySchema('urbanebolt');
